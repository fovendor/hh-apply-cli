...
- [Установка](#установка)
  ...
  - [Шаг 2: Установка hhcli и зависимостей](#шаг-2-установка-hhcli-и-зависимостей)
...
### Шаг 2: Установка `hhcli` и зависимостей
...
2. **Создайте файл скрипта `hhcli`:**
    ...
    ```bash
    # Создаем файл
    sudo nano /usr/local/bin/hhcli
    ```

3. **Скопируйте код** скрипта `hhcli` и вставьте его в открывшийся редактор `nano`.
...
4. **Сделайте скрипт исполняемым:**
    ...
    ```bash
    sudo chmod +x /usr/local/bin/hhcli
    ```
