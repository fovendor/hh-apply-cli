...
COVER_FILE="полный/путь/к/вашему/сопроводительному/письму.txt"
...
# Зачеркивать КОНКРЕТНЫЕ вакансии (тот же ID/url), куда уже был отклик
STRIKETHROUGH_APPLIED_VAC=1

# Зачеркивать вакансии с тем же названием и компанией, куда уже был отклик
STRIKETHROUGH_APPLIED_VAC_NAME=0
