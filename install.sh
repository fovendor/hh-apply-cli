...
HHCLI_RAW_URL="https://raw.githubusercontent.com/fovendor/hhcli/master/hhcli"
CONFIG_RAW_URL="https://raw.githubusercontent.com/fovendor/hhcli/master/config.sh"
